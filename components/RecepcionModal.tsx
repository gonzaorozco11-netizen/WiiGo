      ...
      <div className="bg-white w-full sm:max-w-2xl rounded-t-2xl sm:rounded-2xl max-h-[92vh] overflow-y-auto">
        <div className="px-6 pt-6 pb-4 border-b border-neutral-200 flex items-start justify-between">
          <div>
            ...
            <h2 className="text-xl font-semibold text-neutral-900">
              {esPendiente ? "Recepcionar pedido" : "Orden de Pedido"}
            </h2>
            <p className="text-xs text-neutral-400 mt-0.5">
              #{codigo} · {new Date(orden.fecha).toLocaleDateString("es-AR", { day: "2-digit", month: "long", year: "numeric" })}
            </p>
          </div>
        ...
        <div className="px-6 py-5 space-y-5">
          <div className="flex items-center justify-between">
            ...
            <span className={`text-xs font-semibold rounded-full px-2.5 py-1 ${ESTADO_ESTILO[orden.estado] ?? "bg-neutral-100 text-neutral-600"}`}>
